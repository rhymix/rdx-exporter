...
$lang->zip_password_desc = 'Setting a password for the archive enhances security, but it may increase the time required for export and import. If you don\'t set a password, please delete the archive files immediately after the operation to prevent unauthorized access.';
$lang->yes = 'Yes';
$lang->no = 'No';
