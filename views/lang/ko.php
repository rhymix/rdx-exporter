...
$lang->zip_password_desc = '암호를 설정하면 보안이 강화되지만, 내보내기 및 들여오기 소요 시간이 증가할 수 있습니다. 암호를 설정하지 않으실 경우, 작업 후 즉시 압축 파일을 삭제하여 웹에서 접근할 수 없도록 하시기 바랍니다.';
$lang->db_charset = 'DB 문자셋';
$lang->yes = '예';
$lang->no = '아니오';
